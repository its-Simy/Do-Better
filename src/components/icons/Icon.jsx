...
/* Do Better — icon set
 * Icons are Lucide (https://lucide.dev, ISC license). Paths are inlined here for
 * reliable rendering inside React without a runtime DOM-scan. 24×24, 2px stroke,
 * round caps/joins, fill none — Lucide's defaults. Add more by copying path data.
 */
export const DB_ICON_PATHS = {
...
export function Icon({ name, size = 20, color = 'currentColor', strokeWidth = 2, style = {} }) {
  const inner = DB_ICON_PATHS[name] || '';
  return (
    <svg
